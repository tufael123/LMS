...
<p class="text-center" style="font-size: 20px;">Libery Management System  <a href="login.php">Login</a></p>
...
<?php 
 	if (isset($_POST['submit'])) {
 		...
 		$sql = "INSERT INTO `user`(`s_name`, `f_name`, `m_name`, `dod`, `blood`, `gender`, `phone`, `g_phone`,`per_careof`, `per_village`, `pdivi`, `pdist`, `p_posto`, `image`, `nid`, `email`, `password`)

 			 VALUES ('$s_name','$f_name','$m_name','$dod','$blood','$gender','$phone','$g_phone','$per_careof','$per_village','$pdivi','$pdist','$p_posto','$image','$nid', '$email','$password')";
