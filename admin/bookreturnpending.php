...
$sql = "SELECT * FROM issued_book
        ...
        WHERE DATE_ADD(issued_book.datee, INTERVAL issued_book.days DAY) < CURDATE() AND return_status = 0";
                   ...
                   <tbody>
					    ...
					    ?>
					        <tr>
					            ...
					            <td><a href="book_return.php?id=<?php echo $data['issue_id'] ?>" class="btn btn-info btn-sm" style="width: 100px; font-size: 14px; font-weight: bolder;">Take Return</a></td> 
					        </tr>
					    <?php } ?>
					</tbody>
