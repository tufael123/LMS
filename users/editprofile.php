		...
		<form class="pb-3" action="" method="post">
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<input type="text" required="" value="<?php echo $data['g_phone'] ?>" name="g_phone" class="form-control" style="width: 450px;">
				</div>
			</div>
			...
			<div class="row mt-5">
				<div class="col-md-6">
					...
					<input type="password" required="" value="<?php echo $data['password'] ?>" name="password" class="form-control">
				</div>
			</div>
			<div class="row mt-5">
				<div class="col-md-6">
